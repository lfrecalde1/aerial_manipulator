...
w_ref = line(t(1:length(w_ref)),w_ref);
...
%% Legend nomeclature
hLegend_4 = legend([w,w_ref],{'$\omega$','$\omega_{ref}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1.1*fontsizeTicks)
%% Figure properties
ax_4 = gca;
...
q1p_ref = line(t(1:length(q1p_ref)),q1p_ref);
...
%% Legend nomeclature
hLegend_5 = legend([q1p,q1p_ref],{'$\dot{q}_1$','$\dot{q}_{1ref}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1.1*fontsizeTicks)
%% Figure properties
ax_5 = gca;
...
q2p_ref = line(t(1:length(q2p_ref)),q2p_ref);
...
%% Legend nomeclature
hLegend_6 = legend([q2p,q2p_ref],{'$\dot{q}_2$','$\dot{q}_{2ref}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1.1*fontsizeTicks)
%% Figure properties
ax_6 = gca;
...
q3p_ref = line(t(1:length(q3p_ref)),q3p_ref);
...
%% Legend nomeclature
hLegend_7 = legend([q3p,q3p_ref],{'$\dot{q}_3$','$\dot{q}_{3ref}$'},'fontsize',11,'interpreter','latex','Color',[255 255 255]/255,'NumColumns',1,'TextColor','black');
set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1.1*fontsizeTicks)
%% Figure properties
ax_7 = gca;
